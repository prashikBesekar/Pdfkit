...
function LoginPage() {
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            const { data, error } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["signIn"])(formData.email, formData.password);
            if (error) {
