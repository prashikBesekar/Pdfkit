...
import { Mail, Lock, User, Eye, EyeOff, Loader2, FileText, Github } from 'lucide-react'
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 text-white flex items-center justify-center p-4">
        <div className="max-w-md w-full text-center">
          ...
          <p className="text-sm text-slate-500 mb-6">
            Please verify your email address to complete registration. Redirecting to login...
          </p>
        ...
        <div className="max-w-md w-full">
          ...
          <div className="bg-gradient-to-br from-cyan-500/10 to-blue-500/10 border border-cyan-500/20 rounded-2xl p-8 backdrop-blur-sm">
            <div className="text-center mb-8">
              ...
              <p className="text-slate-400">Start using DocMerge for free</p>
            </div>
